...
const Socios = () => {
    ...
    const handleApprove = async (socio) => {
        ...
        try {
            // Mock update for now or assuming update.php supports partial updates
            // Ideally implementing api/socios/approve.php would be cleaner but let's reuse update or assumptions
